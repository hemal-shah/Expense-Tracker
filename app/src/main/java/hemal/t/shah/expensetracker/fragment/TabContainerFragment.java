...
public class TabContainerFragment extends Fragment {
  ...
  @BindView(R.id.tl_activity_tab_container) TabLayout tabLayout;

  @BindView(R.id.vp_activity_tab_container) ViewPager viewPager;
  ...
  @OnClick(R.id.fab_activity_tab_container) public void fabNewCluster() {
    ...
    builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
      @Override public void onClick(DialogInterface dialog, int which) {
        ...
        if (is_shared == 0) { //personal query
          ...
          dataInsertionTask.startQuery(SharedConstants.TOKEN_CHECK_FOR_CLUSTER_TITLE, null,
              ExpenseContract.ClusterEntry.CONTENT_URI, null, selection, new String[] { title },
              null);
